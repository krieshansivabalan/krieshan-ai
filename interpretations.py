...
# ── Moon in D9 — Emotional Nature in Marriage ────────────────────────────────
NAVAMSA_MOON_INTERP = {
    "Aries": "Your emotional core in marriage is spontaneous and fiercely independent. You need a partner who gives you space to feel without requiring explanation — and who can match your speed when passion ignites. In partnership, your instincts are fast and your moods are brief; you process through action, not conversation. You are most at peace when the relationship feels alive, moving, and free of unnecessary compromise.",
    "Taurus": "The Moon in Taurus Navamsa is exalted — your deepest emotional need in marriage is security, constancy, and sensory warmth. You are nourished by routine, physical affection, shared meals, and a home that feels genuinely beautiful. You are extraordinarily loyal once settled, and your partner will feel anchored by the steadiness of your emotional presence. Your inner world is slow to disturb and slow to heal — take time before committing, and once you do, it is absolute.",
    "Gemini": "Emotionally, you process marriage through conversation and mental exchange. You need a partner who talks with you, thinks with you, and can shift with your emotional weather without anxiety. Your inner life is rich, quick, and sometimes contradictory — you feel two things simultaneously and are comfortable with that complexity. The relationship that nourishes you most is one that never becomes intellectually or emotionally predictable.",
    "Cancer": "Moon in Cancer Navamsa places the emotional instinct at the very center of your marriage. You love through protective tenderness — through remembering, anticipating, and creating a world that feels safe for both of you. Your emotional life is deep and cyclical; you will need a partner who understands your tides without being threatened by them. Home-making in the deepest sense — emotional, physical, and ancestral — is your primary love language.",
    "Leo": "In marriage, your emotional need is to be genuinely celebrated and to celebrate in return. You feel most alive when the relationship has warmth, generosity, and a sense of shared joy. Your instincts are dramatic and loyal — you do not do anything halfway emotionally. A partner who sees you fully, takes pride in you, and receives your warmth with equal enthusiasm will give your marriage the fuel it needs to sustain itself beautifully over time.",
    "Virgo": "Your emotional nature in marriage is quietly devoted and intensely attentive. You feel by noticing — by caring for the small things that make your partner's life better. The risk is directing the inner critic inward or at your partner; the gift is that your love, when expressed, is one of the most genuine and practically sustaining of all. You need a partner who recognizes quality of care over performance of affection.",
    "Libra": "Emotionally, you require harmony as a basic condition of inner peace. Conflict within the marriage is genuinely painful for you — not because you are weak, but because your nervous system is calibrated for connection, not war. You are happiest when the relationship feels balanced, gracious, and aesthetically warm. You are also deeply fair-minded: you bring as much as you receive, and you need a partner who does the same.",
    "Scorpio": "Moon in Scorpio Navamsa is debilitated — your emotional depth in marriage is oceanic and transformative, and it demands a partner who can hold that depth without flinching. You feel things completely and rarely forget. The emotional challenges of this placement — jealousy, intensity, the difficulty of trust — are also its gifts: you are capable of a love that reaches into the soul and permanently changes both people. Choose carefully, and once you do, be willing to be truly known.",
    "Sagittarius": "Emotionally, you need freedom within commitment — space to grow, explore, and bring new experience back into the relationship. You are nourished by philosophy, humor, shared adventure, and a partner who is genuinely their own person. The marriage that works for you is one that expands your world rather than containing it. Your emotional generosity is real and your need for honesty is non-negotiable — you cannot thrive inside a relationship built on comfortable illusions.",
    "Capricorn": "Your emotional need in marriage is for respect, reliability, and the quiet satisfaction of building something real together. You do not perform your feelings easily, but they run deep and last long. You are most nourished by a partner who demonstrates love through consistency and integrity rather than grand declarations. The emotional work of this placement is learning to be warm as well as dependable — to let your partner feel loved, not just secure.",
    "Aquarius": "Emotionally, you process marriage through a dual lens of intimacy and independence. You love deeply and somewhat unusually — you need a partner who is also your most trusted friend. Your instinct is to observe before feeling, to understand before reacting. The relationship that nourishes you allows both partners to be fully themselves, to support each other's causes, and to return to genuine companionship as the bedrock of the union.",
    "Pisces": "Moon in Pisces Navamsa makes your emotional experience of marriage one of the most spiritually rich and potentially overwhelming in the zodiac. You feel the boundaries between yourself and your partner as genuinely permeable — you absorb their emotional state, dream their dreams, and love in a way that makes no distinction between giving and receiving. The gift is profound empathic intimacy. The practice is maintaining your own center while remaining fully open.",
}

# ── Mars in D9 — Passion & Drive in Marriage ─────────────────────────────────
NAVAMSA_MARS_INTERP = {
    "Aries": "Mars in its own sign in the Navamsa brings fierce, direct passion to your marriage. You pursue your partner with conviction and expect the same energy in return. Physical chemistry is central to the health of the union — when that spark is alive, the relationship thrives; when it dims, you notice immediately. Your drive within partnership is self-initiated and sometimes impatient; the practice is learning that commitment is a long game played with consistent energy, not only peak intensity.",
    "Taurus": "In Taurus Navamsa, Mars slows from a sprint to a sustained burn — your desire in marriage is sensual, possessive, and remarkably enduring. You build toward what you want with patience and expect the rewards of loyalty and physical presence. Your capacity for sustained effort within the relationship is one of your greatest assets. The shadow is stubbornness when the path forward requires flexibility rather than force.",
    "Gemini": "Mars in Gemini Navamsa energizes your mind within marriage — you pursue your partner intellectually, your arguments are spirited but not cruel, and your desire often expresses through wit and verbal intensity. You need mental stimulation as much as physical closeness. The relationship is energized by novelty, debate, and shared curiosity; it stagnates when routine replaces discovery.",
    "Cancer": "Mars is debilitated in Cancer Navamsa — your drive within marriage is protective rather than aggressive, deeply emotional rather than direct. You fight for those you love with fierce loyalty, but your own needs often come out sideways rather than straightforwardly. Learning to express desire and frustration directly — rather than through mood or withdrawal — is the core Mars practice in this placement. When mastered, your protective energy becomes one of the most powerful forces in the relationship.",
    "Leo": "Mars in Leo Navamsa brings dramatic, generous passion to your marriage. You pursue your partner with warmth and flair, and you expect the relationship to feel genuinely exciting. Your will within partnership is strong and sometimes proud; you need a partner who respects your energy without being diminished by it. When the relationship affirms your worth and you affirm theirs in return, the creative output of this union is extraordinary.",
    "Virgo": "Mars in Virgo Navamsa channels drive into precision and service within marriage. You work for your partner — practically, efficiently, and with genuine dedication. Your desire expresses through improvement: making things better, solving problems, refining the shared life. The shadow is criticism deployed as control; the gift is that when your energy is well-directed, you create one of the most functionally excellent partnerships imaginable.",
    "Libra": "Mars in Libra Navamsa is in detriment — your drive within marriage is constantly weighed against fairness, harmony, and the needs of your partner. You have strong desires but hesitate to assert them fully, which can create a slow-burning frustration. The practice is learning that directness within relationship is an act of respect, not aggression. When you bring your full will to the partnership while remaining genuinely considerate, you become a remarkably balanced and powerful partner.",
    "Scorpio": "Mars in Scorpio Navamsa — its own sign — brings transformative, magnetic intensity to your marriage. Your desire is total and your will in partnership is nearly unbreakable. You pursue depth, psychological truth, and complete loyalty, and you will not accept a relationship that operates on the surface. The intensity of this placement can feel overwhelming to less Mars-strong partners, but to the right person it is the most compelling and real love they will ever experience.",
    "Sagittarius": "Mars in Sagittarius Navamsa brings adventurous, philosophical energy to your drive in marriage. You pursue shared meaning — through travel, learning, spiritual exploration, and the ongoing expansion of what the relationship can become. Your passion is idealistic and generous; the relationship is at its best when both partners are growing toward something larger than themselves together.",
    "Capricorn": "Mars is exalted in Capricorn Navamsa — the highest expression of disciplined desire. Your drive within marriage is patient, strategic, and extraordinarily productive. You do not waste energy on impulsive expressions; instead you build — slowly, surely, and with a long-term vision that makes the partnership genuinely powerful over time. Your partner experiences your will as a form of devotion: the kind that shows up every day and keeps building long after the initial passion has been absorbed into structure.",
    "Aquarius": "Mars in Aquarius Navamsa directs desire toward shared vision and intellectual freedom within marriage. You are energized by a partner who has their own strong will and pursues their own path — you want to build something together that matters beyond just the two of you. Your passion can seem detached at times, but it is real; it simply operates at the level of purpose rather than purely personal feeling.",
    "Pisces": "Mars in Pisces Navamsa softens drive into compassionate, spiritually attuned energy within marriage. Your desire is fluid and empathic — you often sense what your partner needs before they can articulate it. The challenge is maintaining direction and personal will when the emotional currents of the relationship become overwhelming. The gift is that your passion, when focused, has a quality of divine sacrifice — a love that genuinely loses itself in service to the other.",
}

# ── Jupiter in D9 — Grace & Wisdom in Marriage ───────────────────────────────
NAVAMSA_JUPITER_INTERP = {
    "Aries": "Jupiter in Aries Navamsa brings an expansive, pioneering quality of wisdom to your marriage. You grow through the relationship's courage and initiative — through the willingness to begin, to risk, and to lead together into new territory. Your partner may inspire you toward greater confidence and action. The marriage itself is a spiritual path defined by the courage to begin — again and again, wherever necessary.",
    "Taurus": "Jupiter in Taurus Navamsa blesses the marriage with material grace, sensory richness, and a slowly accumulating abundance. The spiritual dimension of your partnership is built through shared appreciation of beauty, comfort, and the simple satisfaction of a life well-tended. Your partner brings wisdom about value — what is truly worth having and holding. Prosperity often accompanies this union when both partners invest in its foundations.",
    "Gemini": "Jupiter in Gemini Navamsa expands the marriage through ideas, communication, and intellectual discovery. The grace in this union comes from genuine curiosity — both partners are each other's teachers and students simultaneously. Learning, travel, and the ongoing exchange of perspectives keep the relationship alive and growing. The wisdom your marriage develops is specifically the wisdom of seeing every experience from more than one angle.",
    "Cancer": "Jupiter is exalted in Cancer Navamsa — the most auspicious position for Jupiter's blessings in marriage. Your partnership is defined by deep emotional grace, nurturing abundance, and a familial warmth that extends beyond the two of you into the world. The marriage tends to produce genuine happiness and often material sufficiency. Your partner may be a source of profound emotional wisdom, and the home you build together becomes a place of real blessing for all who enter it.",
    "Leo": "Jupiter in Leo Navamsa brings royal generosity and creative expansiveness to your marriage. The spiritual dimension of the partnership is expressed through celebration, creativity, and the joyful affirmation of each other's worth. Your union has a quality of genuine warmth that others feel and are drawn toward. The marriage grows through the courage to be fully seen — to love and be loved not in private reserve but with an open and magnanimous heart.",
    "Virgo": "Jupiter in Virgo Navamsa channels wisdom into refinement, service, and the ongoing improvement of both partners and the partnership itself. The grace of this marriage comes through the accumulated small acts of devotion — through the careful, consistent attention to what makes the relationship genuinely excellent. Your partner may be a teacher of discernment, and the wisdom you develop together is the wisdom of quality over quantity in all domains of life.",
    "Libra": "Jupiter in Libra Navamsa blesses the marriage with grace, fairness, and an elevated aesthetic sense. The partnership is philosophically oriented toward justice and beauty — toward building something genuinely harmonious and ethically sound. Your partner may bring legal, artistic, or diplomatic wisdom, and the relationship itself tends toward a refined, balanced quality. The spiritual lesson of this union is the deep practice of genuine reciprocity.",
    "Scorpio": "Jupiter in Scorpio Navamsa brings profound transformative wisdom to the marriage. The grace of this union comes through depth — through the willingness to go into the difficult places together and emerge wiser and more whole. Your partnership has an occult or psychological quality to it; the spiritual dimensions of relationship are ones both partners take seriously. The wisdom developed here is among the most hard-won and most enduring.",
    "Sagittarius": "Jupiter in its own sign in Sagittarius Navamsa — maximum philosophical grace and expansive blessing for the marriage. The partnership is defined by shared meaning, mutual teaching, and the ongoing co-creation of a life aligned with truth. Both partners call out the highest in each other. Travel, spiritual practice, higher learning, and the cultivation of wisdom are central to what makes this union extraordinary. The marriage itself becomes a kind of guru.",
    "Capricorn": "Jupiter is debilitated in Capricorn Navamsa — the wisdom available here comes through the lessons of structure, limitation, and earned achievement within the marriage. Blessings may arrive slowly and require consistent effort, but they are lasting when they come. Your partner may teach you about discipline, patience, and the long game of building something real. The spiritual practice of this union is learning that grace is not always effortless — sometimes it is the fruit of sustained commitment.",
    "Aquarius": "Jupiter in Aquarius Navamsa expands the marriage toward humanitarian vision and collective wisdom. The grace of this union extends beyond the couple into the world — both partners are energized by the sense that their relationship serves something larger than themselves. Your partner may bring original, progressive, or visionary wisdom, and together you tend to create something genuinely unusual and ahead of its time.",
    "Pisces": "Jupiter in its own sign in Pisces Navamsa — oceanic spiritual grace and unconditional love define the deepest dimension of your marriage. The partnership carries a quality of sacredness; both partners sense that something beyond ordinary life is at work in bringing and keeping them together. The wisdom you develop together is compassionate, all-encompassing, and genuinely spiritual. This is a marriage that touches the divine.",
}

# ── Vargottama Interpretation ─────────────────────────────────────────────────
VARGOTTAMA_INTERP = {
    "Sun": "Your Sun is Vargottama — the same sign in both D1 and D9. This amplifies solar qualities (leadership, identity, life purpose) to an unusually concentrated degree. In the context of marriage, your sense of self and individuality will be a central theme — the right partner must genuinely celebrate who you are at your core, not reshape you. This Sun has full strength in both charts: your soul's purpose shines through clearly.",
    "Moon": "Your Moon is Vargottama — powerfully doubled in sign strength across both charts. Your emotional nature and instinctive responses are especially pronounced and consistent. In marriage, what you need emotionally is non-negotiable and will not adapt or compromise easily. This is a gift of clarity: you know what you need. Choose a partner whose nature can genuinely meet that without resentment.",
    "Mercury": "Your Mercury is Vargottama — the same sign in D1 and D9 amplifies communication, intellect, and analytical ability. Your mind is a primary vehicle for how you engage with both life and partnership. In marriage, shared intellectual life and clear, honest communication are not optional extras — they are the foundation. Your Mercury's consistency makes you a reliable and perceptive communicator within relationships.",
    "Venus": "Your Venus is Vargottama — deeply auspicious for love and marriage. The same sign in both D1 and D9 means your capacity for love, your aesthetic nature, and your values in partnership are fully expressed and unusually strong. What you love, you love completely. What you find beautiful, you pursue without ambivalence. This is among the most powerful Venus placements for a rich and authentic romantic life.",
    "Mars": "Your Mars is Vargottama — drive, passion, and desire are amplified and made consistent across both charts. In marriage, your physical energy, willpower, and capacity for decisive action are fully present and undiluted. You pursue what you want with sustained clarity of intention. The right partner will match or appreciate that intensity; the wrong one will feel overwhelmed by it.",
    "Jupiter": "Your Jupiter is Vargottama — the planet of wisdom, grace, and abundance is doubly strong. In marriage, this amplifies the philosophical and spiritual dimensions of partnership. You are genuinely blessed in the domain of relationships — the capacity for wisdom, generosity, and growth within a committed union is one of your soul's strongest gifts. Trust Jupiter's guidance when choosing a partner.",
    "Saturn": "Your Saturn is Vargottama — the planet of karma, discipline, and endurance is fully expressed in both charts. In marriage, your capacity for long-term commitment, patient devotion, and the building of something structurally sound is exceptional. The relationship will likely deepen over years and decades in ways that shorter-term unions never achieve. Honor the Saturnine qualities of loyalty and steady presence — they are your greatest marital assets.",
    "Rahu": "Your Rahu is Vargottama — the shadow node of desire and worldly ambition is amplified across both charts. The themes of ambition, foreign connections, unconventional paths, and intense desire may play a more prominent role in your marriage than for most people. The relationship may come through unusual circumstances or involve cross-cultural elements. Watch for the Rahu tendency toward insatiability — the practice is learning when enough is genuinely enough.",
    "Ketu": "Your Ketu is Vargottama — the node of past karma and spiritual detachment is doubled in strength. In marriage, there is a strong past-life quality to your most significant relationships — a sense of completion, of old business being resolved. You may encounter partners who feel immediately familiar in a way that transcends the ordinary. The spiritual dimension of your marriage is not incidental; it is central to why you are here.",
    "Ascendant": "Your Ascendant is Vargottama — the lagna is the same in both D1 and D9. This is exceptionally auspicious: your physical self, personality, and marriage persona are in complete alignment. How you appear to the world is how you approach marriage; there is no hidden self that the relationship will eventually reveal as incompatible. You are genuinely who you appear to be in the context of love.",
}

# ── Elemental Balance in D9 ───────────────────────────────────────────────────
D9_ELEMENT_INTERP = {
    "Fire": "Your D9 chart is predominantly Fire-element — Aries, Leo, and Sagittarius signs dominate. In marriage, you bring extraordinary enthusiasm, courage, and warmth. The relationship is energized by shared vision and the mutual fanning of ambition and purpose. You need a partner who can both handle and reciprocate that heat — someone who is not diminished by your intensity but ignited by it. The fire of this chart, when channeled well, makes the marriage genuinely inspiring.",
    "Earth": "Your D9 chart is predominantly Earth-element — Taurus, Virgo, and Capricorn signs dominate. In marriage, you bring stability, loyalty, and the patient capacity to build something enduring. You are nourished by material comfort, practical reliability, and the accumulation of shared resources and experiences over time. The right partner for this chart is grounded, trustworthy, and values substance over performance. The marriage, when well-tended, becomes a fortress of mutual security.",
    "Air": "Your D9 chart is predominantly Air-element — Gemini, Libra, and Aquarius signs dominate. In marriage, you bring intellectual richness, communicative grace, and a genuine gift for connecting at the level of mind and principle. You need a partner who is also intellectually alive — who can talk, debate, envision, and evolve. The relationship is most alive when both partners are genuinely interested in each other's inner world and shared ideas.",
    "Water": "Your D9 chart is predominantly Water-element — Cancer, Scorpio, and Pisces signs dominate. In marriage, you bring extraordinary emotional depth, empathic sensitivity, and an instinctive capacity for genuine intimacy. You feel your partner's inner life as much as you observe their outer behavior. The right partner for this chart is someone emotionally mature enough to receive profound care without being overwhelmed by it, and deep enough to nourish your soul in return.",
    "Balanced": "Your D9 chart shows a relatively balanced distribution of elements — no single element dominates. This brings versatility and adaptability to your marriage: you can meet partners from many different elemental makeups and find genuine common ground. The practice with a balanced chart is developing clarity about which elements you personally need most in a partner, since the chart itself doesn't give a single strong signal — that knowledge must come from self-awareness.",
}
...
# ── D10 Lagna — Professional Persona ──────────────────────────────────────────
D10_LAGNA_INTERP = {
    "Aries": "Your career persona is that of the driven initiator — the one who moves first, acts boldly, and refuses to wait for permission. In professional life, you project an unmistakable forward energy that can inspire teams and unsettle competitors in equal measure. Your identity at work is bound to action: you feel most alive when you are starting something, solving something, or taking a risk others hesitate to take. The challenge is learning when to consolidate rather than always charge ahead, since the most enduring careers are built from well-completed projects as much as bold beginnings.",
    "Taurus": "Your career persona is that of the steady builder — methodical, reliable, and committed to quality that lasts. Colleagues and employers instinctively feel they can depend on you, which quietly earns you more professional ground than you may realize. You bring a patient accumulative intelligence to your work, preferring to do things thoroughly rather than hastily, and over time this becomes one of your greatest professional assets. Your identity in career is shaped by what you have created and sustained, and true recognition comes when others can see the solidity of what you have built.",
    "Gemini": "Your career persona is that of the versatile communicator — curious, adaptable, and capable of operating fluently across multiple domains at once. In professional settings, you are the person who bridges different teams, translates complex ideas, and finds connections others miss. Your identity at work is tied to your mind and your words, and you thrive in environments that reward quick thinking, diverse skills, and the ability to engage with a range of people and problems. The key is learning to focus that remarkable range into a coherent professional narrative, so others see depth alongside the breadth.",
    "Cancer": "Your career persona is that of the nurturing leader — someone who builds professional environments defined by care, loyalty, and emotional intelligence. You lead through attunement rather than authority, sensing what your team or clients need and orienting your work accordingly. Your professional identity is deeply tied to the people you serve and the communities you build, and lasting career satisfaction comes when your work genuinely nourishes or protects others. The caution is allowing emotional sensitivity to become over-investment in others' reactions — your gifts are strongest when paired with clear professional boundaries.",
    "Leo": "Your career persona is that of the visible authority — someone who commands natural attention and whose professional presence is felt in any room. You are drawn to roles that carry real significance, and your best work happens when you have genuine creative latitude and the platform to express it fully. Recognition matters to you not as mere ego but because visibility is the medium through which your contributions create real impact. The deeper work is ensuring that the need for recognition never overshadows the substance beneath it — when your confidence is grounded in genuine competence, your career presence becomes truly magnetic.",
    "Virgo": "Your career persona is that of the precise specialist — someone who brings discernment, analytical skill, and an exacting attention to detail that elevates whatever you touch. In professional life, you are the person others turn to when accuracy matters, when a process needs refining, or when a complex problem needs to be broken into its working parts. Your identity at work is bound to doing things correctly, and over time this builds a professional reputation for reliability and expertise that few can match. The growth edge is recognizing that good enough, delivered on time, often serves the work better than perfect, delivered late.",
    "Libra": "Your career persona is that of the diplomatic collaborator — someone who brings grace, fairness, and a genuine skill for navigating relationships and competing interests in professional settings. You are at your best in environments that require negotiation, creative partnership, or the building of consensus, and your ability to see all sides of a situation is a professional gift that often goes undervalued until it is needed most. Your career identity is shaped by the quality of your professional relationships and your reputation for fairness. The challenge is developing the decisiveness that transforms your natural balance into genuine leadership.",
    "Scorpio": "Your career persona is that of the deep investigator — someone who penetrates surfaces, exposes what is hidden, and brings an intensity of focus to professional work that others rarely match. You are drawn to work that carries real stakes, and you bring a psychological acuity to your field that gives you insight into motivations and dynamics others simply do not see. Your professional identity is forged through transformation — you are at your best not despite the difficult assignments but because of them. The maturation of this persona comes when you learn to wield your insight with strategic restraint rather than revealing everything you know.",
    "Sagittarius": "Your career persona is that of the visionary teacher — someone who works with ideas, principles, and the larger meaning behind facts, and who has the gift of expanding others' sense of what is possible. You are drawn to careers that involve exploration, whether of geography, philosophy, culture, or the frontiers of a given field, and your professional identity is fundamentally tied to growth. You inspire colleagues and clients not just with what you know but with the direction you point them in. The practice is developing the discipline to complete the journey you begin — vision without follow-through leaves brilliant ideas unrealized.",
    "Capricorn": "Your career persona is that of the disciplined executive — someone who takes professional responsibility seriously, earns authority through sustained competence, and builds career structures that are meant to last decades. You are instinctively drawn to positions of governance, management, or institutional leadership, and your professional identity is shaped by what you have achieved through effort and time. Others recognize you as someone who can be trusted with real power because you exercise it carefully. The inner work is ensuring that professional ambition remains connected to genuine purpose, so that the summit you climb is one that truly matters to you.",
    "Aquarius": "Your career persona is that of the innovative reformer — someone who sees the current system clearly enough to envision how it must be changed, and who brings that vision into professional spaces with intelligence and conviction. You are drawn to work that is ahead of its time, and your professional identity is bound to ideas, movements, and collective futures rather than individual glory. Colleagues often experience you as both inspiring and puzzling, because you operate from principles others have not yet arrived at. The growth edge is learning to communicate your vision in terms that build coalitions rather than simply broadcasting from a higher altitude.",
    "Pisces": "Your career persona is that of the intuitive creator — someone who works from feeling as much as from thinking, and who brings imagination, empathy, and spiritual depth to whatever field you inhabit. Your professional gifts include an ability to sense what is needed before it is articulated, to create work that resonates at an emotional and even transcendent level, and to move fluidly between roles and domains as circumstances call for. Your career identity is not easily captured in a title or a resume, because what you offer is a quality of presence and perception that transforms the work itself. The practice is developing enough structure to sustain and deliver your considerable creative gifts consistently.",
}

# ── D10 10th House — Peak Career Expression ───────────────────────────────────
D10_10TH_INTERP = {
    "Aries": {
        "domain": "Your career peak is expressed through fields of initiation, competition, and direct action — arenas where speed, courage, and leadership under pressure are the defining currencies.",
        "professions": "You are drawn toward roles such as entrepreneur, athlete, military officer, emergency responder, or pioneer in any rapidly evolving industry.",
        "success_path": "Lasting recognition in this domain comes not from the first bold move but from the discipline to follow through and lead consistently once the initial fire has been lit. Your career peaks when you transform raw initiative into strategic momentum, and when others see you not just as a starter but as someone who sees things through to meaningful completion.",
    },
    "Taurus": {
        "domain": "Your career peak is expressed through fields of building, sustaining, and creating tangible value — arenas where patience, craftsmanship, and long-term accumulation define excellence.",
        "professions": "You are drawn toward roles such as financial advisor, architect, land developer, luxury brand specialist, agriculturalist, or any vocation where the quality of the output endures.",
        "success_path": "Lasting recognition comes through the quality and permanence of what you create — your reputation is built slowly, through work that stands up to time and repeated scrutiny. The career peaks when you stop measuring success by pace and start measuring it by depth, and when others trust you precisely because you never cut corners.",
    },
    "Gemini": {
        "domain": "Your career peak is expressed through fields of communication, information, and intellectual exchange — arenas where the ability to synthesize, translate, and transmit ideas creates real professional value.",
        "professions": "You are drawn toward roles such as journalist, writer, publicist, educator, data analyst, content strategist, or any career that rewards a quick and versatile mind.",
        "success_path": "Lasting recognition comes when you develop a signature voice or area of expertise that anchors your wide-ranging intelligence, because versatility alone is eventually outcompeted by depth. Your career peaks when the breadth of your knowledge serves a clear and compelling professional purpose, and others seek you out as the person who uniquely bridges worlds they cannot bridge themselves.",
    },
    "Cancer": {
        "domain": "Your career peak is expressed through fields of care, community, and emotional sustenance — arenas where the ability to nurture, protect, and create belonging defines the highest professional contribution.",
        "professions": "You are drawn toward roles such as counselor, healthcare provider, social worker, hospitality professional, educator of young people, or nonprofit leader.",
        "success_path": "Lasting recognition comes not from institutional power but from the genuine loyalty of the people you have served and the communities you have helped build. Your career peaks when your work creates something that continues to nourish others long after you have moved on — when the care you invested becomes a living legacy.",
    },
    "Leo": {
        "domain": "Your career peak is expressed through fields of performance, leadership, and creative expression — arenas where visibility, authority, and the power to inspire others are the highest professional achievements.",
        "professions": "You are drawn toward roles such as executive, performer, director, politician, creative director, public speaker, or any position that places you at the center of meaningful action.",
        "success_path": "Lasting recognition comes when your visibility is inseparable from genuine excellence — when the platform you occupy is earned through sustained quality and not merely pursued for its own sake. Your career peaks when others are genuinely elevated by your leadership and when your creative authority produces work that outlasts any single role or moment of acclaim.",
    },
    "Virgo": {
        "domain": "Your career peak is expressed through fields of analysis, service, and technical mastery — arenas where precision, process, and the meticulous improvement of systems create the highest professional value.",
        "professions": "You are drawn toward roles such as researcher, editor, healthcare specialist, data scientist, systems analyst, quality assurance professional, or technical consultant.",
        "success_path": "Lasting recognition comes when your mastery is so thorough that others cannot afford not to have you, when your name becomes synonymous with standards of excellence that raise the entire field. Your career peaks when the work you do quietly and carefully turns out to be the invisible infrastructure that everything else depends on.",
    },
    "Libra": {
        "domain": "Your career peak is expressed through fields of partnership, aesthetics, and justice — arenas where the ability to create balance, broker agreements, and cultivate beauty defines the highest professional contribution.",
        "professions": "You are drawn toward roles such as lawyer, mediator, diplomat, designer, curator, relationship manager, or any career built on the quality of professional alliances.",
        "success_path": "Lasting recognition comes through the reputation you build as someone who is both fair and effective — whose name carries credibility in rooms full of competing interests. Your career peaks when your relational intelligence is paired with decisive action, transforming natural diplomacy into genuine leadership that others trust and follow.",
    },
    "Scorpio": {
        "domain": "Your career peak is expressed through fields of investigation, transformation, and concentrated power — arenas where the willingness to go deep, face what is hidden, and catalyze fundamental change defines the highest professional achievement.",
        "professions": "You are drawn toward roles such as psychologist, surgeon, researcher, forensic specialist, intelligence analyst, transformational consultant, or any field requiring unflinching depth.",
        "success_path": "Lasting recognition comes through work that others recognize as genuinely transformative — through discoveries, interventions, or creations that could only have come from someone willing to go where others will not. Your career peaks when your intensity is fully directed and your professional power is exercised with the kind of ethical discipline that makes others trust you with the most consequential work.",
    },
    "Sagittarius": {
        "domain": "Your career peak is expressed through fields of wisdom, teaching, and expansive exploration — arenas where vision, philosophical depth, and the ability to orient others toward larger truths create lasting professional impact.",
        "professions": "You are drawn toward roles such as professor, author, spiritual teacher, international consultant, explorer, publisher, or any career that operates at the intersection of knowledge and meaning.",
        "success_path": "Lasting recognition comes when your vision is not merely expansive but also grounded — when you have done the sustained work of turning insight into wisdom that others can actually apply. Your career peaks when your name becomes associated with a body of thought or contribution that expands the horizon of your entire field.",
    },
    "Capricorn": {
        "domain": "Your career peak is expressed through fields of governance, institution-building, and structural leadership — arenas where the capacity to take responsibility, exercise authority, and build for the long term defines the highest professional achievement.",
        "professions": "You are drawn toward roles such as executive officer, government official, senior administrator, institutional founder, engineer, or any career that ultimately demands real accountability for outcomes.",
        "success_path": "Lasting recognition comes through the weight of what you have been responsible for and how well you have carried it — through a career record that speaks not of brilliance alone but of sustained, delivered results. Your career peaks when you occupy positions of genuine authority that you have clearly earned through years of competent, disciplined, and ethically grounded work.",
    },
    "Aquarius": {
        "domain": "Your career peak is expressed through fields of innovation, social reform, and collective advancement — arenas where the ability to think differently, challenge entrenched systems, and serve the larger good defines the highest professional contribution.",
        "professions": "You are drawn toward roles such as technologist, social entrepreneur, activist, futurist, researcher in emerging fields, policy architect, or any career that serves humanity's next chapter.",
        "success_path": "Lasting recognition comes when your innovations or reforms are proven out by time — when what seemed radical is eventually recognized as prescient and necessary. Your career peaks when your intellectual independence serves a cause larger than personal success, and when the systems or ideas you helped create genuinely improve how people live and work.",
    },
    "Pisces": {
        "domain": "Your career peak is expressed through fields of imagination, healing, and spiritual service — arenas where the ability to sense what lies beyond the visible, to create meaning, and to dissolve boundaries between the ordinary and the transcendent defines the highest professional gift.",
        "professions": "You are drawn toward roles such as artist, musician, therapist, healer, filmmaker, spiritual guide, or any career in which imagination and empathy are the primary professional tools.",
        "success_path": "Lasting recognition comes through work that moves people at a level they cannot fully explain — art that stays with them, healing that reaches parts of themselves they had closed off, or guidance that reconnects them to something essential. Your career peaks when you stop trying to justify your gifts in purely rational terms and simply offer them fully, trusting that the world needs exactly what you carry.",
    },
}

# ── D10 Sun — Authority & Leadership Style ────────────────────────────────────
D10_SUN_INTERP = {
    "Aries": "With the Sun in Aries in your D10, your authority in career is expressed through courage, directness, and the willingness to act before others have even framed the problem. You earn professional respect not by waiting for consensus but by demonstrating through action that your instincts are sound. Leadership for you is fundamentally about momentum — you lead from the front and inspire others by example rather than decree. The growth edge is learning that authority sustained over the long term requires as much listening as it does asserting, and that the boldest leaders are often the ones who know when to pause.",
    "Taurus": "With the Sun in Taurus in your D10, your authority in career is expressed through unwavering reliability, material competence, and a steadiness that others find deeply reassuring in turbulent professional environments. You earn respect through the quality of your output and the consistency of your character — people trust you because you have never given them reason not to. Your leadership style is patient, grounded, and deeply practical, oriented toward building things that will last rather than impressing in the short term. The deeper work is ensuring your steadiness does not calcify into resistance to necessary change.",
    "Gemini": "With the Sun in Gemini in your D10, your authority in career is expressed through intellectual versatility, communicative skill, and the ability to navigate complexity with a nimbleness that leaves others scrambling to keep up. You earn professional respect by demonstrating that you understand not just the immediate task but the broader context, the relationships between ideas, and the implications that others have not yet considered. Your leadership style is collaborative and conversational, drawing on others' intelligence while synthesizing it into forward motion. The key is developing a clear and consistent professional identity so that your range is experienced as mastery rather than restlessness.",
    "Cancer": "With the Sun in Cancer in your D10, your authority in career is expressed through emotional intelligence, protective leadership, and a capacity for genuine care that creates loyalty no incentive structure could manufacture. You earn professional respect by demonstrating that you take people seriously — not just as performers but as whole human beings — and this quality attracts remarkable dedication from those who work with and for you. Your leadership style is intuitive and relational, built on attunement and trust rather than hierarchy and command. The growth is learning that expressing vulnerability and setting limits are not contradictions of your authority but the very things that deepen it.",
    "Leo": "With the Sun in Leo in your D10, your authority in career is expressed through natural command, creative confidence, and a generosity of spirit that draws others into your orbit and makes them want to contribute to what you are building. You earn professional respect through a combination of genuine excellence and the unmistakable radiance of someone who truly believes in their work. Your leadership style is inspiring and declarative — you set the vision, hold the standard, and expect others to rise to it. The maturation of this Sun is learning that the greatest authority is exercised not in dominating the room but in creating conditions where others discover their own excellence.",
    "Virgo": "With the Sun in Virgo in your D10, your authority in career is expressed through mastery of craft, analytical precision, and a quiet but formidable competence that gradually earns a professional reputation that no amount of self-promotion could manufacture. You earn respect by consistently producing work of exceptional quality and by being the person who actually understands how things work at a level of detail that others cannot access. Your leadership style is service-oriented and systems-driven, leading through capability and thoroughness rather than charisma or rank. The growth edge is learning to claim the authority your competence has already earned, without hiding behind the role of the humble specialist.",
    "Libra": "With the Sun in Libra in your D10, your authority in career is expressed through fairness, aesthetic intelligence, and the rare capacity to hold competing interests in a productive tension that leads to outcomes better than either side could have reached alone. You earn professional respect by being genuinely balanced — not a pushover, but someone whose judgment others trust because it is visibly uncontaminated by self-interest. Your leadership style is collaborative and relationally sophisticated, building authority through the quality of your alliances and the reputation of your decisions. The challenge is developing a decisiveness that can deliver on all the potential your balanced perception creates.",
    "Scorpio": "With the Sun in Scorpio in your D10, your authority in career is expressed through depth, psychological acuity, and a formidable capacity for sustained concentration that makes you extraordinarily effective in high-stakes professional environments. You earn respect not by asking for it but by demonstrating an insight into situations and people that others recognize as genuinely exceptional and somewhat uncanny. Your leadership style is intense, strategic, and quietly powerful — you do not lead loudly but your influence runs deep. The maturation of this Sun is learning to deploy your perceptive gifts with a generosity of spirit that invites others into your trust rather than keeping them perpetually at arm's length.",
    "Sagittarius": "With the Sun in Sagittarius in your D10, your authority in career is expressed through wisdom, expansive vision, and a philosophical confidence that orients others toward larger purposes and longer time horizons. You earn professional respect by demonstrating that you see further than the immediate, that your understanding is rooted in genuine study and experience, and that you consistently point toward something worth striving for. Your leadership style is inspirational and principle-driven, drawing others forward with ideas and meaning rather than managing them with rules and metrics. The growth edge is developing the practical focus to translate that vision into measurable results that make believers out of those who need more than inspiration.",
    "Capricorn": "With the Sun in Capricorn in your D10, your authority in career is expressed through structural integrity, earned rank, and a professional gravitas that accumulates steadily over years of disciplined and responsible work. You earn respect through your track record — through a career history that demonstrates consistent delivery, sound judgment, and the willingness to accept the full weight of accountability. Your leadership style is measured, institution-minded, and oriented toward outcomes that outlast any individual tenure. The deeper work is ensuring the professional structures you build and inhabit remain animated by genuine purpose rather than becoming ends in themselves.",
    "Aquarius": "With the Sun in Aquarius in your D10, your authority in career is expressed through originality of mind, principled independence, and a professional identity that is deliberately ahead of its time. You earn respect by consistently seeing what others have not yet seen and by being willing to stand for it before the rest of the field has caught up. Your leadership style is unconventional, collaborative in an egalitarian spirit, and driven by ideas and collective outcomes rather than personal prestige. The maturation of this Sun is learning to operate with enough pragmatic intelligence that your innovations actually land in the world rather than remaining brilliant in the realm of concept.",
    "Pisces": "With the Sun in Pisces in your D10, your authority in career is expressed through intuitive wisdom, compassionate presence, and a quality of perception that allows you to sense what a situation truly requires at a level beneath the visible facts. You earn professional respect in ways that are difficult to articulate — people simply feel better, clearer, or more inspired when you are involved in a project or decision. Your leadership style is gentle but deeply felt, and your influence often operates through the example of your inner life as much as through any explicit act of authority. The growth is learning to hold your own professional identity with enough clarity and confidence that your empathic gifts do not diffuse into shapelessness.",
}

# ── D10 Saturn — Career Karma & Discipline ────────────────────────────────────
D10_SATURN_INTERP = {
    "Aries": "With Saturn in Aries in your D10, the karmic demand of your career is to learn that sustainable achievement requires patience and strategic restraint as much as bold action. You may find that early professional ambitions meet friction, delays, or the frustrating experience of acting decisively only to have circumstances require you to wait — this is Saturn's curriculum, not your inadequacy. The reward that accumulates over time is an extraordinary capacity for disciplined initiative: the ability to move quickly when the moment is right because you have learned to hold your energy in reserve until it is. Career mastery arrives for you when impulsivity is alchemized into strategic courage.",
    "Taurus": "With Saturn in Taurus in your D10, the karmic demand of your career is to build with genuine care and long-term intention, resisting the temptation to equate professional worth with material accumulation alone. You may encounter tests around financial security, resource scarcity, or the slow pace at which tangible results arrive — Saturn in this sign requires that you trust the process of gradual accumulation even when the returns feel distant. The reward over time is a professional solidity that few can match: assets, reputation, and competence built so carefully and sustainably that they endure through cycles that sweep away less grounded careers. Your work becomes most powerful when it is offered in genuine service to lasting value.",
    "Gemini": "With Saturn in Gemini in your D10, the karmic demand of your career is to develop the discipline to take your intellectual gifts seriously enough to build real mastery from them. You may encounter early professional experiences of being underestimated, of scattered focus, or of not being heard despite having something genuinely important to say — Saturn here is insisting that you do the work of becoming precise, substantive, and consistently credible. The reward that accumulates is a formidable intellectual authority: the kind of expertise that combines breadth with real depth, making you a professional resource others cannot easily replace. Your career reaches its potential when thought becomes craft.",
    "Cancer": "With Saturn in Cancer in your D10, the karmic demand of your career is to learn how to lead and succeed professionally without suppressing the emotional intelligence that is actually your greatest asset. You may encounter tension between the vulnerability that authentic caregiving requires and the armored persona that conventional professional environments seem to reward — Saturn here is working through that contradiction toward a deeper integration. The reward over time is the capacity for leadership that combines warmth with genuine authority: the rarest and most powerful professional combination. Your career is most enduring when you stop pretending that professional excellence and emotional depth are opposites.",
    "Leo": "With Saturn in Leo in your D10, the karmic demand of your career is to earn the visibility and authority you seek rather than assuming it belongs to you by natural right. You may experience frustration, professional eclipse, or the experience of talented people being overlooked while less capable ones receive recognition — this is Saturn's insistence that the foundation of real authority be laid carefully. The reward that accumulates over time is an authority so clearly earned and so substantively grounded that it does not require performance to be felt by others. Your career reaches its highest expression when you discover that true leadership is far more demanding and far more satisfying than mere recognition.",
    "Virgo": "With Saturn in Virgo in your D10, the karmic demand of your career is to develop a mastery of craft so thorough that it becomes effortless — to move from anxious perfectionism into true professional excellence. You may encounter early professional experiences of never feeling ready, of being too self-critical to advance, or of investing enormous effort in work that goes unrecognized because it is embedded in the invisible infrastructure others take for granted. The reward that accumulates is a technical authority and a professional reputation for exactitude that becomes genuinely irreplaceable. Your career reaches its potential when you trust your competence enough to offer it without apology.",
    "Libra": "With Saturn in Libra in your D10, the planet is exalted, which means career karma operates here with unusual power and eventual grace — but the tests are real and must be honored. The karmic demand is to develop genuine fairness, professional integrity, and the ability to make just and considered decisions even when they are costly. You may experience career challenges through partnerships, legal matters, or the slow and difficult work of building professional alliances that have real foundations rather than mere convenience. The reward over time is an extraordinary professional reputation — the kind that causes people to defer to your judgment because your track record of fairness is so consistent as to be trustworthy without question.",
    "Scorpio": "With Saturn in Scorpio in your D10, the karmic demand of your career is to confront the deepest professional shadows — power dynamics, corruption, hidden agendas, and the temptation to use your perceptive gifts for control rather than service. You may encounter career experiences that force you into proximity with institutional darkness, betrayal, or the experience of having your own ambition tested against your ethics. The reward that accumulates over time is an unshakeable professional integrity — the kind forged not in easy circumstances but in the places where compromise was possible and you chose not to. Your career becomes most powerful when your depth is matched by an equally deep commitment to doing things right.",
    "Sagittarius": "With Saturn in Sagittarius in your D10, the karmic demand of your career is to develop the discipline to make your vision practical — to earn the authority to teach, guide, or lead by doing the sustained intellectual and experiential work that gives you something genuinely worth offering. You may encounter professional experiences where your optimism outruns your preparation, where your beliefs are tested by facts, or where you are asked to prove rather than simply declare. The reward that accumulates is a genuine wisdom authority — the kind of professional standing that comes from someone who has lived what they teach and whose perspective has been proven across time and difficulty.",
    "Capricorn": "With Saturn in Capricorn in your D10, the planet is in its own sign and operates at its most characteristic — demanding the most rigorous professional discipline and offering the most enduring career rewards to those who meet the demand fully. The karmic test is whether you are willing to accept the full weight of long-term responsibility, to work without shortcuts, and to build your career structure stone by patient stone. You may find that professional advancement is deliberately slow, that authority must be thoroughly earned before it is granted, and that corners cannot be cut without immediate and serious consequences. The reward is a career of genuine permanence — a professional legacy that outlasts trends, downturns, and the passage of decades.",
    "Aquarius": "With Saturn in Aquarius in your D10, the karmic demand of your career is to develop the discipline required to translate genuinely innovative thinking into forms that create real change in the actual world. You may encounter professional experiences of being ahead of your time in ways that feel isolating, of having unconventional approaches dismissed before they are understood, or of needing to operate within systems you find frustrating in order to eventually transform them. The reward that accumulates is a professional authority rooted in proven originality — the standing of someone who was right about the future before it arrived. Your career reaches its potential when you stop waiting for the world to catch up and start building the bridges that help it do so.",
    "Pisces": "With Saturn in Pisces in your D10, the karmic demand of your career is to develop structure and professional discipline in domains that inherently resist them — to find the form that allows your intuitive, creative, or spiritual gifts to be expressed with enough consistency and reliability to create lasting professional impact. You may experience career challenges around boundaries, self-discipline, escapism, or the difficulty of translating deeply felt inner knowing into executable professional action. The reward that accumulates over time is a rare and formidable combination: the soul of an artist or mystic operating with the professionalism of a master craftsperson. Your career reaches its highest expression when the boundless and the bounded are held together in productive tension.",
}

# ── D10 Mercury — Professional Skills & Communication ─────────────────────────
D10_MERCURY_INTERP = {
    "Aries": "With Mercury in Aries in your D10, your professional thinking style is fast, direct, and decisively oriented toward action — you cut through complexity and arrive at conclusions ahead of others, which in the right environments is an extraordinary asset. Your communication at work carries an edge and an urgency that motivates and sometimes challenges those around you, and your best professional contributions often come in the early stages of a problem when someone needs to think on their feet. The growth edge is developing the patience to communicate to audiences whose processing pace is different from yours, and learning when deliberate slowness in thinking produces better outcomes than rapid-fire insight.",
    "Taurus": "With Mercury in Taurus in your D10, your professional thinking style is deliberate, grounded, and oriented toward practical outcomes and tangible results — you are not a fast processor by temperament, but what you produce when you have thought something through properly is reliably sound. Your communication at work is steady and concrete, and colleagues trust your assessments because they know you do not speculate carelessly. The professional asset here is intellectual reliability over time — the reputation of someone whose thinking holds up to scrutiny. The growth edge is developing flexibility in your ideas, remaining genuinely open to new information even after your initial assessment has been formed.",
    "Gemini": "With Mercury in Gemini in your D10, the planet is in its own sign and your professional intellectual gifts operate at full strength — curiosity, speed, versatility, and the ability to hold multiple perspectives simultaneously without losing coherence. Your communication at work is engaging, adaptive, and capable of speaking to very different audiences with equal fluency. The professional asset here is genuine cognitive range that serves equally well in creative work, analytical work, and interpersonal negotiation. The growth edge is developing the discipline to go deep rather than always moving laterally, so that the breadth of your intelligence is anchored in at least one domain of genuine mastery.",
    "Cancer": "With Mercury in Cancer in your D10, your professional thinking style is intuitive, empathic, and deeply attuned to the emotional undercurrents of any situation — you often know what a colleague or client needs before they have articulated it, and this gives your communication a quality of care that builds professional trust. Your intellectual process is not always linear, and you may find that your best professional insights arrive as feelings before they arrive as words, which requires you to develop the craft of translating inner knowing into clear external communication. The growth edge is learning to trust your intuitive intelligence in professional settings where more analytical styles are dominant.",
    "Leo": "With Mercury in Leo in your D10, your professional communication style is confident, expressive, and naturally commanding — you speak in a way that people remember, and your professional ideas carry the conviction of someone who has genuinely considered them and genuinely believes in them. You are at your intellectual best when given creative latitude, when presenting to an audience, or when advocating for something you are personally invested in. The growth edge is developing the intellectual humility to genuinely receive feedback and the ability to listen as powerfully as you speak, so that your communicative gifts are embedded in a conversational intelligence that draws others in rather than broadcasting to them.",
    "Virgo": "With Mercury in Virgo in your D10, the planet is both in its own sign and exalted, making this one of the most powerful Mercury placements for professional intellectual performance — your analytical precision, attention to detail, and capacity for discernment operate at an exceptional level. Your communication at work is exact, evidence-based, and deeply credible, and your professional value is often located in your capacity to see what others have missed in the details. The growth edge is learning to communicate your insights in terms that land effectively with audiences who do not share your exactitude, and resisting the perfectionist tendency to withhold contributions until they are complete in every particular.",
    "Libra": "With Mercury in Libra in your D10, your professional thinking style is relational, aesthetically sensitive, and oriented toward balance — you naturally see multiple sides of any professional situation and have a gift for finding the formulation that all parties can work with. Your communication at work is diplomatic and measured, which makes you exceptionally effective in negotiations, partnerships, and professional environments that require consensus-building. The growth edge is developing the willingness to take a clear position when balance becomes indecision, and ensuring that the grace of your communication is matched by the substance of what you are actually advocating for.",
    "Scorpio": "With Mercury in Scorpio in your D10, your professional thinking style is penetrating, strategic, and unusually attuned to what is not being said — you read subtext, detect inconsistency, and can follow a line of inquiry to depths that most professionals never approach. Your communication at work carries an intensity and precision that commands attention, and your professional analyses are valued precisely because they are unwilling to stay on the surface. The growth edge is developing a communicative openness that allows colleagues to feel included in your thinking rather than evaluated by it, and learning to use your perceptive gifts to build professional trust rather than to maintain strategic advantage.",
    "Sagittarius": "With Mercury in Sagittarius in your D10, your professional thinking style is expansive, principled, and oriented toward the large-scale significance of things — you are less interested in the details than in what they mean, and your intellectual contribution at work is most powerful when it is connecting the immediate situation to a larger context or longer trajectory. Your communication is enthusiastic, idea-rich, and capable of inspiring others by the sheer scale of what you are imagining. The growth edge is developing a precision in execution that matches the ambition of your vision, and ensuring that the inspiring overview you offer is supported by engagement with the particulars that make or break any real outcome.",
    "Capricorn": "With Mercury in Capricorn in your D10, your professional thinking style is disciplined, strategic, and oriented toward outcomes — you think in terms of structures, hierarchies, and long-term consequences, and your intellectual contributions carry the weight of someone who has considered what things cost and what they build. Your communication at work is measured, authoritative, and efficient, and you have a gift for cutting through noise to the essential point that actually matters for the decision at hand. The growth edge is developing a communicative warmth and flexibility that allows you to connect with colleagues across different working styles, so that your intellectual authority is paired with genuine relational intelligence.",
    "Aquarius": "With Mercury in Aquarius in your D10, your professional thinking style is innovative, systems-oriented, and comfortably ahead of current consensus — you naturally see patterns across large data sets of information and can arrive at conclusions that are both logically sound and genuinely surprising. Your communication at work is inventive and often provocative in the best sense, introducing ideas that shift how others are thinking about a problem. The growth edge is developing the communicative patience to bring others along with your thinking rather than simply presenting conclusions that, however correct, leave your audience too far behind to act on them.",
    "Pisces": "With Mercury in Pisces in your D10, your professional thinking style is associative, imaginative, and deeply attuned to nuance, symbol, and the emotional register of information — you process the world in a non-linear way that can frustrate more analytical environments but produces insights of genuine originality and depth. Your communication at work is empathic and evocative, and you often find that metaphor and narrative carry your professional ideas more effectively than logical argument. The growth edge is developing the discipline to translate your richly textured inner understanding into forms that are clear and actionable enough for professional settings where precision and practicality are the working languages.",
}

# ── Amatyakaraka — Career Significator (Jaimini) ──────────────────────────────
AMATYAKARAKA_INTERP = {
    "Sun": "When the Sun is your Amatyakaraka, your career is fundamentally about authority, visibility, and the expression of your individual dharma in the world — work is not simply a means of livelihood but the arena in which your core identity is most fully tested and realized. You are drawn to positions of leadership, governance, and public significance, and you carry an instinctive understanding that your professional role carries genuine responsibility for those who are affected by your decisions. The career paths most aligned with this Amatyakaraka include government service, executive leadership, medicine, performing arts, and any vocation where your personal authority is both the tool and the offering. To honor this placement, you must consistently cultivate the courage to act from principle rather than convenience, the integrity to wield power in genuine service, and the humility to remember that the authority you carry belongs ultimately to the role and not merely to you. The Sun Amatyakaraka asks that your career be an act of solar offering — your distinctive light brought fully and generously into public life.",
    "Moon": "When the Moon is your Amatyakaraka, your career is fundamentally about care, attunement, and the capacity to nourish and respond to the needs of others in a professional context. You are drawn to vocations that bring you into emotional and relational contact with people — where your ability to sense what is needed, adapt fluidly to changing conditions, and hold space for others' inner lives becomes your most essential professional contribution. The career paths most aligned with this Amatyakaraka include counseling, healthcare, hospitality, education, child development, social work, and any field where the quality of human connection is the primary product. To honor this placement, you must learn to trust your emotional intelligence as a professional tool rather than apologizing for it, and to establish the personal boundaries that allow you to give generously over a long career without depleting yourself. The Moon Amatyakaraka asks that your work be an act of genuine receptivity — an ongoing willingness to meet others where they are and serve from that meeting point.",
    "Mars": "When Mars is your Amatyakaraka, your career is fundamentally about courage, competition, and the capacity to act decisively in high-stakes environments where lesser professionals hesitate or retreat. You are drawn to vocations that require strength, initiative, and the willingness to enter contests — literal, professional, or intellectual — and to emerge having given everything. The career paths most aligned with this Amatyakaraka include military service, athletics, surgery, engineering, entrepreneurship, law enforcement, and any field that rewards those who combine physical or strategic intensity with disciplined skill. To honor this placement, you must channel your considerable drive into disciplined and purposeful action rather than scattered aggression, and you must develop the wisdom to know which battles genuinely merit your full force. The Mars Amatyakaraka asks that your career be an act of warrior service — not of war for its own sake, but of bringing your full fighting capability to bear in defense of what is genuinely worth protecting.",
    "Mercury": "When Mercury is your Amatyakaraka, your career is fundamentally about intelligence, communication, and the capacity to navigate information, language, and professional relationships with a versatility and precision that creates real value in the world. You are drawn to vocations that require you to think clearly, communicate effectively, and move nimbly across domains — and your greatest professional asset is the quality of your mind and the range of what it can do. The career paths most aligned with this Amatyakaraka include writing, journalism, teaching, consulting, commerce, data analysis, and any field where the ability to synthesize and transmit knowledge is the core professional offering. To honor this placement, you must commit to developing genuine expertise rather than remaining forever at the level of interesting generalist, and you must take your communicative gifts seriously enough to invest in the craft of becoming truly excellent at them. The Mercury Amatyakaraka asks that your career be an act of intellectual service — your mind offered in clarity, precision, and genuine usefulness to those you serve.",
    "Jupiter": "When Jupiter is your Amatyakaraka, your career is fundamentally about wisdom, teaching, and the expansion of others' understanding, opportunity, and sense of what is possible. You are drawn to vocations that carry genuine philosophical or ethical weight — roles in which you are expected to know deeply, to guide consistently, and to embody the principles you advocate. The career paths most aligned with this Amatyakaraka include law, academia, philosophy, religious or spiritual leadership, finance, publishing, and any field in which the transmission of wisdom is the primary professional act. To honor this placement, you must continue growing throughout your career — reading, traveling, questioning, and expanding — because a stagnant Jupiter Amatyakaraka eventually has nothing left to offer except the echo of past learning. The Jupiter Amatyakaraka asks that your career be an act of generous wisdom — an ongoing investment in becoming more genuinely knowledgeable, more ethically grounded, and more capable of elevating those who come to you for guidance.",
    "Venus": "When Venus is your Amatyakaraka, your career is fundamentally about beauty, refinement, and the capacity to create value through aesthetic intelligence, relational grace, and the elevation of human experience. You are drawn to vocations that engage your sensory and relational gifts — where the quality of what is made or the experience of the relationship is itself the professional offering. The career paths most aligned with this Amatyakaraka include the arts, design, music, fashion, diplomacy, counseling, luxury industries, and any field in which the pursuit of beauty, harmony, or genuine human connection is taken seriously as a professional discipline. To honor this placement, you must resist the temptation to undervalue aesthetic and relational intelligence in professional environments that privilege harder metrics, and you must commit to developing your craft — in art, in relationship, in taste — to the level where it creates irreplaceable value. The Venus Amatyakaraka asks that your career be an act of loving refinement — an ongoing dedication to bringing more grace, beauty, and genuine connection into the professional world you inhabit.",
    "Saturn": "When Saturn is your Amatyakaraka, your career is fundamentally about mastery, accountability, and the willingness to accept the full weight of long-term professional responsibility in service of something genuinely important. You are drawn to vocations that carry the weight of real consequences — where what you build or fail to build actually matters over decades, and where the discipline and integrity you bring to your work are inseparable from the quality of what gets created. The career paths most aligned with this Amatyakaraka include law, engineering, government, institutional leadership, administration, and any field where sustained, disciplined, long-term contribution is the primary form of professional service. To honor this placement, you must embrace the slow pace at which Saturnine career rewards arrive, resisting the comparison to peers who advance more quickly through less rigorous paths, and trusting that what Saturn builds it builds to last. The Saturn Amatyakaraka asks that your career be an act of karmic integrity — a willingness to do the hard work, take the full responsibility, and build something that will still be standing long after the easier achievements of your generation have dissolved.",
}

# ── Soul Profile ──────────────────────────────────────────────────
# Light side keyed by Sun sign — highest expression of the solar self
SOUL_LIGHT = {
    "Aries":       "A natural pioneer whose courage ignites momentum in everyone around them. At your highest, you are fearless in the face of the unknown, generously sharing your fire to help others begin what they only dream about. Your directness is a gift — you cut through illusion and act when others hesitate, making real what was once only potential.",
    "Taurus":      "A grounding force of steadiness, beauty, and unwavering loyalty. At your best you create sanctuary — physical, emotional, financial — reminding those around you that patience and deep presence are forms of profound power. Your gift is the ability to build things that last and to make the world more beautiful simply by being in it.",
    "Gemini":      "A brilliant connector of ideas, people, and possibilities. Your curiosity is a living gift — you synthesise worlds that others keep separate and translate complex truths into language anyone can receive. At your highest, your quick mind becomes a bridge, lighting up the world with wit, warmth, and ideas that genuinely move people forward.",
    "Cancer":      "A deep nurturer whose emotional intelligence is extraordinary and rare. You sense what others cannot say, hold what others cannot carry, and your capacity for unconditional love and protection is one of the most powerful forces in any room. At your highest you are the safe harbour that allows others to become who they truly are.",
    "Leo":         "A radiant creative force who uplifts simply by being fully and unapologetically yourself. Your generosity of spirit, warmth, and gift for celebration make life richer for everyone in your orbit. At your best you lead not through authority but through authentic self-expression — your light gives others permission to shine too.",
    "Virgo":       "A master of refinement who sees the sacred in the details most people overlook. Your discernment, dedicated service, and extraordinary ability to improve everything you touch are profound gifts. At your highest you are the healer and the craftsperson in one — your precision creates work of lasting beauty and your care changes lives quietly and completely.",
    "Libra":       "A natural harmoniser and architect of fairness whose gift is seeing the truth in all perspectives. You have an extraordinary capacity for creating beauty, building genuine connection, and designing the kind of relationships and systems in which people truly thrive. At your highest you hold space for opposing truths and weave them into something greater.",
    "Scorpio":     "An alchemist of depth and transformation who carries the courage to go where others will not. At your highest you transmute pain into wisdom, guide others fearlessly through their darkness, and embody an emotional depth and integrity that most people spend a lifetime trying to reach. Your presence alone is a catalyst for truth.",
    "Sagittarius": "A visionary philosopher and seeker of ultimate truth whose optimism is a genuine force for good. Your perspective is expansive, your enthusiasm contagious, and your ability to inspire others toward growth, meaning, and adventure is virtually unmatched. At your best you are the teacher, the explorer, and the living proof that life is a sacred journey.",
    "Capricorn":   "A master builder with a long vision and an iron discipline that creates real, lasting change in the world. Your ability to honour commitment, structure meaningful effort, and manifest ambitious goals over time is a rare and powerful gift. At your highest you build not just for yourself but as a legacy — something that will stand long after you.",
    "Aquarius":    "A revolutionary visionary who sees what humanity could become and has the courage to stand apart in service of that future. Your originality, your compassion for the collective, and your refusal to accept the world as it is make you a genuine agent of change. At your highest you build communities and ideas that liberate people from limitation.",
    "Pisces":      "A mystic, healer, and artist of the unseen whose empathy is boundless and whose imagination touches the divine. You carry the wisdom of all twelve signs and when you trust your inner knowing you channel beauty, compassion, and healing that transcends the ordinary world. At your highest you dissolve the illusion of separation and remind others they are not alone.",
}

# Shadow side keyed by Moon sign — emotional patterns and reactive wounds
SOUL_SHADOW = {
    "Aries":       "The shadow impulse is to act before feeling — to escape discomfort through anger, impulsivity, or restlessness. When emotionally triggered, patience evaporates and words or actions can wound before the mind catches up. The deeper wound beneath the fire is often an unacknowledged fear of powerlessness or of being overlooked.",
    "Taurus":      "The shadow pulls toward rigidity and accumulation as substitutes for emotional security. Resistance to necessary change can calcify into stubbornness, and the comfort-seeking instinct can quietly become avoidance of growth. Possessiveness — of people, things, or ways of being — is the shadow side of the deep Taurus loyalty.",
    "Gemini":      "The shadow scatters attention and uses wit and movement to avoid emotional depth. Anxiety, inconsistency, and surface-level engagement can mask a deeper fear of being truly known or pinned down. When overwhelmed, the mind generates noise rather than clarity, and commitment feels like a trap rather than a foundation.",
    "Cancer":      "The shadow retreats behind emotional walls or clings to those it loves as a way of managing internal fear. Moods can become tidal and consuming, and the unhealed wound of not feeling emotionally safe can manifest as indirect communication, emotional manipulation, or the inability to release the past.",
    "Leo":         "The shadow craves external validation and can collapse in its absence. Pride can harden into defensiveness, and the fear of not being truly seen or appreciated can drive performative behaviour or an unconscious need to outshine rather than uplift. The wound beneath the radiance is often a deep, private question: am I enough on my own?",
    "Virgo":       "The shadow becomes the relentless inner critic — a voice that finds the flaw in everything and never allows rest. Perfectionism generates paralysis, chronic worry blocks the present moment, and the compulsive need to fix or improve can exhaust both self and others. Beneath the precision is often an old belief that love must be earned through usefulness.",
    "Libra":       "The shadow people-pleases to the point of erasure — agreeing, adjusting, and accommodating until the authentic self is nowhere to be found. Indecision, passive-aggression, and the fear of disrupting harmony can lead to deep internal resentment and a chronic disconnection from one's own needs and true desires.",
    "Scorpio":     "The shadow fixates, controls, and tests the loyalty of those it loves through emotional intensity and withholding. Jealousy, the long memory for betrayal, and the need to be the one who holds power in a relationship can poison even the deepest bonds. The wound beneath the intensity is an ancient fear of abandonment and exposure.",
    "Sagittarius": "The shadow commits to nothing and uses restlessness, humour, or philosophical distance to avoid real intimacy. Bluntness becomes cruelty, optimism becomes wilful delusion, and the inability to sit with discomfort or disappointment can prevent the kind of deep, sustained connection the soul is actually searching for.",
    "Capricorn":   "The shadow becomes cold, controlled, and achievement-obsessed at the cost of the heart. Emotional suppression, workaholism, and the unrelenting inner taskmaster can leave you isolated and depleted even at the peak of external success. The wound beneath the discipline is often a deep, old belief that softness is weakness and that rest must be earned.",
    "Aquarius":    "The shadow detaches from personal emotional intimacy while championing abstract humanitarian ideals. Emotional unavailability, contrarianism for its own sake, and the need to remain perpetually different can sabotage the close, vulnerable bonds the soul quietly craves. The wound is often a fear that being truly known will lead to rejection.",
    "Pisces":      "The shadow dissolves boundaries and escapes into fantasy, victimhood, or numbing when reality becomes too sharp. Self-deception, the inability to say no, and the pull toward disappearing into others' worlds can prevent the soul from fully inhabiting its own life. The wound is a deep sensitivity to pain that the world never quite validates.",
}

# Feed this — keyed by Ascendant sign — practices and orientations for growth
SOUL_FEED = {
    "Aries":       "Feed your growth through bold, decisive action — even small daily acts of courage build the confidence this rising sign requires. Channel your fire into physical movement, leadership roles, and new beginnings you actually follow through on. Surround yourself with people who honour your directness and match your drive. Your soul is fed by challenge, not comfort.",
    "Taurus":      "Feed your soul through sensory richness — beautiful food, time in nature, music that moves you, and physical spaces that feel like sanctuary. Honour slow, consistent effort over dramatic bursts of energy. Build financial practices that create genuine security and daily rituals that ground you in your body. Stability is not stagnation — it is your foundation for everything.",
    "Gemini":      "Feed your mind through voracious learning, diverse connection, and creative writing or speaking that gives your ideas a home. Commit to developing depth alongside your natural breadth — one great skill, one sustained project, one deep friendship at a time. Breathwork and meditation calm the nervous system your sign rules and transform anxiety into inspired clarity.",
    "Cancer":      "Feed yourself through sacred home-making, deep honest conversations, and regular time near water. Honour your need for solitude to process what you absorb from others. Nurturing practices — cooking, tending to your home, caring for those you love — fill your well when they come from wholeness rather than obligation. Your soul asks for safety before it can open.",
    "Leo":         "Feed your creative fire through art, play, generous self-expression, and the courage to be seen. Build community around you and practise receiving appreciation without deflecting it. Regular acts of genuine generosity — given freely, without needing recognition — keep your light clean and sustainable. Your soul is fed most deeply by love that asks nothing in return.",
    "Virgo":       "Feed yourself through mastery — developing a craft, deepening your health practices, and serving in ways that have real meaning to you. Regular time in nature recalibrates your nervous system. Journalling and somatic or body-based practices help you move from the endless mental loop into felt experience. Progress matters more than perfection — completion is the practice.",
    "Libra":       "Feed yourself through beauty — art, music, harmonious environments, and the kind of genuine one-on-one connection where both people are fully present. Develop your own opinions through journalling before seeking outside input. Practise making small decisions quickly and trusting yourself. Your soul grows strongest when you stop balancing others and start anchoring in yourself.",
    "Scorpio":     "Feed yourself through depth — therapy, shadow work, transformative practices, and intimate bonds where nothing needs to be hidden. Creative expression through music, writing, or movement gives your intensity a healthy and powerful channel. Honour your need for solitude and regeneration as a non-negotiable — your soul does its deepest work in the dark and the quiet.",
    "Sagittarius": "Feed yourself through travel, philosophy, higher learning, and bold adventures that genuinely expand your worldview. Commit to a spiritual or philosophical practice that gives your search for meaning a real container and not just a direction. Spend time with people whose perspective is radically different from yours — your soul grows by being challenged to see further.",
    "Capricorn":   "Feed yourself through meaningful, purposeful work that connects to a longer legacy than the next milestone. Give yourself permission to schedule joy, rest, and deep relationship with the same discipline you apply to your goals. Reconnect regularly to the WHY beneath your ambitions — your soul does not run on achievement alone, even when it looks like it does.",
    "Aquarius":    "Feed yourself through intellectual community, humanitarian projects, and the freedom to think in ways no one else has thought before. Give yourself full permission to be unconventional. Deep friendships built on genuine shared values — not social obligation — are your true lifeblood. Your soul is fed not by approval but by the freedom to be exactly what you are.",
    "Pisces":      "Feed yourself through creative and spiritual practice — art, music, prayer, meditation, movement, or any form that lets the invisible world speak through you. Time near water, in silence, or in untouched nature replenishes the vast empathy you carry. Develop one grounded, practical discipline to anchor your inner world so your gifts can actually land in reality.",
}

# Avoid this — keyed by Sun sign — patterns and behaviours to consciously release
SOUL_AVOID = {
    "Aries":       "Avoid acting from pure impulse without pausing long enough to feel the full weight of the consequence. Guard against burning bridges in moments of anger, treating stillness as failure, and the restlessness that keeps you perpetually starting without ever finishing. The warrior energy that serves you in crisis can destroy in intimacy — learn to sheath it.",
    "Taurus":      "Avoid mistaking comfort for growth and familiarity for safety. Guard against financial or emotional hoarding as armour against vulnerability, resistance to endings that have long since passed their expiry, and the quiet stubbornness that keeps you locked in situations your soul has already outgrown. Sometimes the most grounded thing you can do is let go.",
    "Gemini":      "Avoid over-committing to everything and delivering on nothing. Guard against using your words and wit to deflect genuine vulnerability, spreading your magnificent energy across so many projects that none of them ever receive your full depth. The scattered mind is not freedom — it is avoidance. Your real power lives in chosen depth.",
    "Cancer":      "Avoid taking on others' emotional weather as if it belongs to you. Guard against retreating into silence when honest, direct communication would heal things far faster, and the pattern of using food, nesting, or nostalgia to avoid the present moment. Your nurturing is a gift — but only when it flows from a full cup, not from self-erasure.",
    "Leo":         "Avoid seeking validation from those who are simply not capable of giving it — and measuring your worth against their silence. Guard against performing generosity in ways that need to be witnessed, letting wounded pride turn small misunderstandings into declarations of war, and the quiet fear that without your achievements you are somehow less than enough.",
    "Virgo":       "Avoid letting the relentless pursuit of perfection become the reason nothing ever gets finished or shared. Guard against turning the inner critic outward onto those you love, using analysis and busyness as a way to avoid feeling what is actually present, and the deep habit of helping others as a substitute for tending to your own unmet needs.",
    "Libra":       "Avoid chronic indecision and people-pleasing that slowly erases the outline of who you actually are. Guard against passive-aggressive communication when direct honesty would heal things far faster, and the long-term cost of keeping surface peace at the price of your authentic self. True harmony includes your truth — not just everyone else's comfort.",
    "Scorpio":     "Avoid using your extraordinary knowledge of others' vulnerabilities as a weapon when you feel cornered or betrayed. Guard against obsessive thinking that turns a wound into a prison, the need to control outcomes you cannot own, and the shadow impulse to destroy what you cannot fully possess. Power-with is your highest path — not power-over.",
    "Sagittarius": "Avoid making promises in the heat of inspiration that you have no real intention of honouring when the feeling fades. Guard against the philosophical arrogance that dismisses others' lived pain as small thinking, commitment avoidance dressed up as freedom, and the habitual use of humour or adventure to escape emotional conversations that actually need to happen.",
    "Capricorn":   "Avoid sacrificing your emotional life, your health, and your closest relationships on the altar of achievement and respectability. Guard against the emotional coldness that keeps genuine intimacy permanently at arm's length, the belief that rest is a reward that must be earned, and the quiet tragedy of reaching the summit only to find you climbed alone.",
    "Aquarius":    "Avoid using intellectual brilliance and conceptual detachment as armour against the vulnerability of being truly close to another person. Guard against the paradox of loving humanity in the abstract while keeping real individuals at a careful distance, rigid contrarianism that opposes simply for the sake of being different, and the isolation that comes from needing no one.",
    "Pisces":      "Avoid dissolving your identity in others' needs, pain, or emotional currents until you can no longer locate yourself. Guard against escapism in any form it takes — substances, fantasy, chronic martyrdom, or the slow fade of a life not fully lived. Your sensitivity is not a flaw to be managed — it is a power that requires clear boundaries to function.",
}


def get_soul_profile(placements: dict) -> dict:
    """
    Build a four-part soul profile from the three key placements:
      - Light side  ← Sun sign
      - Shadow side ← Moon sign
      - Feed this   ← Ascendant sign
      - Avoid this  ← Sun sign (ego's shadow patterns)
    Returns a dict with keys: light, shadow, feed, avoid,
    plus the source sign labels for rendering.
    """
    sun  = placements.get("Sun",       {}).get("sign", "")
    moon = placements.get("Moon",      {}).get("sign", "")
    asc  = placements.get("Ascendant", {}).get("sign", "")

    return {
        "light":       SOUL_LIGHT.get(sun,  ""),
        "shadow":      SOUL_SHADOW.get(moon, ""),
        "feed":        SOUL_FEED.get(asc,   ""),
        "avoid":       SOUL_AVOID.get(sun,  ""),
        "sun_sign":    sun,
        "moon_sign":   moon,
        "rising_sign": asc,
    }
